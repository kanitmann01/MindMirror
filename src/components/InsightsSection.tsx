    ...
    <div className="space-y-6">
      ...
      {aiData ? (
        <Card className="shadow-md border-l-4 border-l-purple-500 bg-gradient-to-r from-purple-50 to-transparent">
            <div className="space-y-4">
                ...
                <Paragraph className="text-base text-gray-700 leading-relaxed whitespace-pre-line">
                    {aiData.narrative}
                </Paragraph>
      ...
      <Row gutter={[16, 16]}>
        ...
        {profile.mbti && (
          <Col xs={24} md={12}>
            <Card 
                title={<div className="flex items-center">Cognitive Architecture <InfoTooltip text="Your Myers-Briggs Type Indicator estimation based on self-report." /></div>} 
      ...
      {/* Methodology Modal */}
      <Modal 
        title="How BrainMirror Calculates Your Profile" 
      ...
      >
          <div className="space-y-4 text-gray-700">
              <Paragraph>
                  BrainMirror combines <strong>established psychological frameworks</strong> with <strong>behavioral data analysis</strong>.
              </Paragraph>
              <div>
